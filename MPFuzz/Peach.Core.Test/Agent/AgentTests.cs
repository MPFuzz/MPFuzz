...
namespace Peach.Core.Test.Agent
{
	...
	public class AgentTests
	{
		...
		public void StartAgent()
		{
			...
			{
				process.StartInfo.FileName = "mpfuzz.exe";
			...
			else
			{
				...
				string mpfuzz = "mpfuzz.exe";
				foreach (var dir in paths)
				{
					var candidate = Path.Combine(dir, mpfuzz);
				...
				process.StartInfo.Arguments = "--debug {0} -a tcp".Fmt(mpfuzz);
			}
