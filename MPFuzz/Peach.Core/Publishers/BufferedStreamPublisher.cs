	...
	public abstract class BufferedStreamPublisher : Publisher
	{
		...
		protected override void OnInput()
		{
			...
			try { WantBytes(1); }
				...
				// Ignore soft exceptions.  This is a hack to get around the fact that
				// we can't tell if the client is still connected or not.
				Logger.Debug("Soft exception in OnInput");
			}
		}
